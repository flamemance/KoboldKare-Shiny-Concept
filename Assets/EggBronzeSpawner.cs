...
public class EggBronzeSpawner : MonoBehaviour {
    ...
    public Penetrator SpawnEggBronze(float eggVolume) {
        ...
        d.GetComponent<GenericReagentContainer>().OverrideReagent(ReagentDatabase.GetReagent("ScrambledEggBronze"), eggVolume);
